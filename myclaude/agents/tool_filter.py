...
def resolve_agent_tools(
    ...
    for tool in mcp_tools.values():
        filtered.register(copy.copy(tool))
...
def build_teammate_tools(
    ...
    from myclaude.tools.send_message import SendMessageTool
    from myclaude.tools.task_create import TaskCreateTool
    from myclaude.tools.task_get import TaskGetTool
    from myclaude.tools.task_list import TaskListTool
    from myclaude.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    """
    from myclaude.tools.agent_tool import FORK_QUERY_SOURCE
    ...
    for tool in parent_registry.list_tools():
        ...
        if tool.name == "Agent" and hasattr(tool, "query_source"):
            ...
            forked.register(copy.copy(tool))
    return forked
