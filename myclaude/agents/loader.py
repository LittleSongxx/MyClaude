...
PROJECT_AGENTS_DIR = ".myclaude/agents"
USER_AGENTS_DIR = "~/.myclaude/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("myclaude.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from myclaude.agents.parser import parse_frontmatter, _validate_agent_meta
