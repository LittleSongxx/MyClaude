...
from myclaude.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from myclaude.agent import Agent
    from myclaude.conversation import ConversationManager
    from myclaude.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from myclaude.conversation import ConversationManager as CM
                conv = CM()
