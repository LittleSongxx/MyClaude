...
from myclaude.teams.backend_detect import BackendDetectionError, detect_backend
from myclaude.teams.mailbox import Mailbox, create_message
...
from myclaude.teams.progress import TeammateProgress
from myclaude.teams.registry import AgentNameRegistry
from myclaude.teams.shared_task import SharedTaskStore
from myclaude.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from myclaude.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
