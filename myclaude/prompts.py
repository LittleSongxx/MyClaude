"""MyClaude 的系统提示词（system prompt）构建。"""
...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are MyClaude, an AI programming assistant running in the terminal. "
...
# Using your tools
 - Do NOT use the Bash tool when a dedicated tool is available. Using dedicated tools lets the user better understand and review your work:
   ...
   - Use DeleteFile instead of rm for deleting a single file
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from myclaude.teams.coordinator import get_coordinator_system_prompt
