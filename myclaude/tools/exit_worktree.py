...
from myclaude.worktree.changes import count_worktree_changes
...
class ExitWorktreeTool(Tool):
    ...
    def __init__(
        ...
        self._on_work_dir_change = on_work_dir_change
    ...
    async def execute(self, params: ExitWorktreeParams) -> ToolResult:
        ...
        try:
            ...
            if self._on_work_dir_change is not None:
                self._on_work_dir_change(original_cwd)
