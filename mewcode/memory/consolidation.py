...
from mewcode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
...
class MemoryConsolidator:
    ...
    async def maybe_run(
        ...
        await self._run(client, conversation, protocol, session_ids, prior_mtime)
    ...
    async def _do_consolidation(
        ...
        from mewcode.tools.delete_file import DeleteFile
